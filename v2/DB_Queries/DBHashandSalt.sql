CREATE TABLE Gestor (id_gestor int IDENTITY NOT NULL, email varchar(255) NOT NULL, password_hash varchar(511) NOT NULL, password_salt varchar(511) NOT NULL, PRIMARY KEY (id_gestor));
