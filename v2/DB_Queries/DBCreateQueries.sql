...
CREATE TABLE Administrador (id_administrador int IDENTITY NOT NULL, email int NOT NULL, password_hash varchar(255) NOT NULL, password_salt varchar(255) NOT NULL, PRIMARY KEY (id_administrador));
